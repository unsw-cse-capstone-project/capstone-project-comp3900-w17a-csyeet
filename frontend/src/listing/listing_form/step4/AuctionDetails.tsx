      ...
      <div className={classes.container}>
        ...
        >
          ...
          <div style={{ padding: "10px" }}>
            <Typography>
              Reserve price is the minimum before the property can be sold. If
              the highest bidding price does not reach the reservation price,
              the property is passed in and you may have to negotiate with
              sellers.
            </Typography>
          </div>
        </Dialog>
